      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="sm:col-span-2 py-6">
          <div
            ...
            data-aos-delay="200"
          >
            <FaJs className="w-12 h-12 text-yellow-400 hover:scale-110 transition-transform" />
            <FaPhp className="w-12 h-12 text-indigo-300 hover:scale-110 transition-transform" />
            <FaReact className="w-12 h-12 text-cyan-400 hover:scale-110 transition-transform" />
            <FaNodeJs className="w-12 h-12 text-green-400 hover:scale-110 transition-transform" />
            <FaDocker className="w-12 h-12 text-blue-400 hover:scale-110 transition-transform" />
            <FaBootstrap className="w-12 h-12 text-purple-400 hover:scale-110 transition-transform" />
            <FaSymfony className="w-12 h-12 text-white hover:scale-110 transition-transform" />
            <FaLaravel className="w-12 h-12 text-red-400 hover:scale-110 transition-transform" />
            <FaAws className="w-12 h-12 text-orange-400 hover:scale-110 transition-transform" />
            <FaAndroid className="w-12 h-12 text-green-500 hover:scale-110 transition-transform" />
            <FaApple className="w-12 h-12 text-gray-300 hover:scale-110 transition-transform" />
