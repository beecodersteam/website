...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-50 via-white to-beePrimary-normal/5 text-gray-900 overflow-hidden">
      ...
      <div className={`absolute inset-0 overflow-hidden animated-bg-container`}>

        <div
          className={`absolute inset-0 bg-gradient-to-b  from-beePrimary-normal/20 via-white to-beePrimary-normal/0 gradient-bg`}
