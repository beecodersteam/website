...
export default function Header() {
  ...
  return (
    <header className={`fixed w-full z-40 bg-opacity-70 bg-beePrimary-normal border-b-4 border-beeSecondary-normal transition duration-300 ease-in-out ${!top ? 'md:bg-opacity-80 backdrop-blur-sm shadow-xl' : ''}`}>
