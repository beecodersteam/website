export default function Highlights() {
  return (
    <section className="relative bg-slate-200 p-4">
      <div className="container mx-auto lg:px-52">
      <div className="container mx-auto px-4 md:px-34 py-8">
        <div className="flex flex-wrap sm:flex-nowrap gap-4 overflow-hidden">

          <div className="overflow-hidden w-full sm:w-1/3 my-2 px-2 md:mr-0" data-aos="zoom-in" data-aos-delay="100">
            <div className="flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#FCC700" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-12 h-12">
          ...
          <div className="overflow-hidden w-full sm:w-1/3 my-2 px-2" data-aos="zoom-in" data-aos-delay="300">
            <div className="flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#FCC700" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-12 h-12">
          ...
          <div className="overflow-hidden w-full sm:w-1/3 my-2 px-2"  data-aos="zoom-in" data-aos-delay="500">
            <div className="flex items-center justify-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#FCC700" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-12 h-12">
