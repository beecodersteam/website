...
export default function SignIn() {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-beePrimary-light/10 via-white to-beeSecondary-light/10 overflow-hidden pt-32 pb-16">
      <AnimatedBackground hexagonCount={6} hexagonColor="bg-beePrimary-normal" backgroundColors={{ from: 'from-beePrimary-normal/10', via: 'via-white/0', to: 'to-beePrimary-light/10' }} />
      <div className="relative z-10 w-full max-w-md mx-auto p-8 md:p-10 bg-white/80 backdrop-blur-md rounded-3xl shadow-2xl border border-beePrimary-light/20">
        ...
        <SectionSubtitle text="Acesse sua conta Bee Coders para continuar." size="md" />
        <form className="space-y-5">
          ...
          <div>
            ...
            <input id="password" type="password" className="form-input w-full text-gray-800" placeholder="Digite sua senha" required />
          </div>
          <div className="flex items-center justify-between">
            ...
            <Link href="/reset-password" className="text-sm font-medium text-beePrimary-normal hover:underline">Esqueceu a senha?</Link>
          </div>
          <button className="btn text-white bg-beePrimary-normal hover:bg-beePrimary-dark w-full shadow-lg transition-all duration-200">Entrar</button>
        </form>
        ...
        <div className="space-y-3">
          <button className="btn px-0 text-white bg-gray-900 hover:bg-gray-800 w-full relative flex items-center">
            ...
            <span className="flex-auto pl-16 pr-8 -ml-16">Entrar com GitHub</span>
          </button>
          <button className="btn px-0 text-white bg-red-600 hover:bg-red-700 w-full relative flex items-center">
            ...
            <span className="flex-auto pl-16 pr-8 -ml-16">Entrar com Google</span>
          </button>
        </div>
        <div className="text-gray-600 text-center mt-6">
          Não possui uma conta? <Link href="/signup" className="text-beePrimary-normal hover:underline transition duration-150 ease-in-out">Cadastre-se</Link>
        </div>
      </div>
    </section>
  )
